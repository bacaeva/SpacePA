...
from django.urls import path
from product.views import ProductsListsView, ProductDetailsView, CreateProductView, UpdateProductView, DeleteProductView

urlpatterns = [
    path('admin/', admin.site.urls),
    path ('products/',ProductsListsView.as_view(),name = 'products-list'),
